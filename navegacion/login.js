...
export default function Login() {
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput style={styles.txtInput} placeholder="karenalfaro@gmail.com" keyboardType="email-address" />
      <TextInput style={styles.txtInput} placeholder="...124s" secureTextEntry={true}/>
